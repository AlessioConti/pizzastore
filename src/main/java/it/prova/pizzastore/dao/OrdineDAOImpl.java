...
public class OrdineDAOImpl implements OrdineDAO {
	...
	public Optional<Ordine> findOneEager(Long id) {
		return entityManager.createQuery(
				"select o from Ordine o left join fetch o.cliente c left join fetch o.utente u where o.id=:idOrdine",
	...
	public List<Ordine> listOrdiniAperti(Long id) throws Exception {
		return entityManager
				.createQuery("select o from Ordine o left join o.utente u where o.closed = 0 and u.id = :idUtente",
						Ordine.class)
