				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteInsertClienteServlet" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<input type="text" name="cognome" id="cognome" class="form-control" placeholder="Inserire il cognome" value="${insert_film_attr.cognome }">
								</div>
								
								<div class="col-md-6">
									<label for="indirizzo" class="form-label">Indirizzo</label>
									<input type="text" name="indirizzo" id="indirizzo" class="form-control" placeholder="Inserire l'indirizzo" value="${insert_film_attr.indirizzo }">
								</div>
